        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Email_Format", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("CK_Phone_Format", "Phone LIKE '01[0125]________'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("Plan_Duration_check", "DurationDays Between 1 and 365");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Email_Format1", "Email LIKE '%_@__%.__%'");
                    table.CheckConstraint("CK_Phone_Format1", "Phone LIKE '01[0125]________'");
                });
